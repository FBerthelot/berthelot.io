import{_ as Tt,u as vt,r as te,i as It,c as R,a as A,t as P,f as x,l as M,F as Rt,g as St,q as At,d as Be,C as Ct,E as Dt,o as S,p as kt,e as Ot}from"./entry.09bc07e3.js";import{u as Ut}from"./index.f5b4c15b.js";import{b as Bt,a as Nt,_ as Pt}from"./agnes_et_florent_19-08-2023-violet.d678877d.js";import"./vue.f36acd1f.0b352876.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(wn(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function wn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ye="@firebase/app",Le="0.9.25";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cs(t){oe(new Y("platform-logger",e=>new yn(e),"PRIVATE")),oe(new Y("heartbeat",e=>new is(e),"PRIVATE")),q(ye,Le,t),q(ye,Le,"esm2017"),q("fire-js","")}cs("");var ls="firebase",us="10.7.1";/**
 * @license
