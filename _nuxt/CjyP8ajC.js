import{_ as It,u as Rt,r as te,i as St,c as R,a as A,t as P,f as M,m as x,F as At,g as Ct,s as Dt,d as Be,E as Ot,H as kt,o as S,p as Ut,e as Bt}from"./ClL02UwP.js";import{u as Nt}from"./BH_s9vDd.js";import{b as Pt,a as Mt,_ as xt}from"./BAB8WPiY.js";import"./Be37PInG.js";var Ne={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Tn(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Tn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ye="@firebase/app",Fe="0.10.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const we="[DEFAULT]",Kn={[ye]:"fire-core",[In]:"fire-core-compat",[Sn]:"fire-analytics",[Rn]:"fire-analytics-compat",[Cn]:"fire-app-check",[An]:"fire-app-check-compat",[Dn]:"fire-auth",[On]:"fire-auth-compat",[kn]:"fire-rtdb",[Un]:"fire-rtdb-compat",[Bn]:"fire-fn",[Nn]:"fire-fn-compat",[Pn]:"fire-iid",[Mn]:"fire-iid-compat",[xn]:"fire-fcm",[Ln]:"fire-fcm-compat",[Fn]:"fire-perf",[$n]:"fire-perf-compat",[Hn]:"fire-rc",[zn]:"fire-rc-compat",[jn]:"fire-gcs",[Vn]:"fire-gcs-compat",[qn]:"fire-fst",[Wn]:"fire-fst-compat","fire-js":"fire-js",[Gn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es=Xn;function rt(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:we,automaticDataCollectionEnabled:!1},e),r=s.name;if(typeof r!="string"||!r)throw B.create("bad-app-name",{appName:String(r)});if(n||(n=et()),!n)throw B.create("no-options");const i=ie.get(r);if(i){if(ge(n,i.options)&&ge(s,i.config))return i;throw B.create("duplicate-app",{appName:r})}const o=new rn(r);for(const a of ve.values())o.addComponent(a);const c=new Qn(n,s,o);return ie.set(r,c),c}function ts(t=we){const e=ie.get(t);if(!e&&t===we&&et())return rt();if(!e)throw B.create("no-app",{appName:t});return e}function q(t,e,n){var s;let r=(s=Kn[t])!==null&&s!==void 0?s:t;n&&(r+=`-${n}`);const i=r.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const c=[`Unable to register library "${r}" with version "${e}":`];i&&c.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),$.warn(c.join(" "));return}oe(new Y(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const is=1024,os=30*24*60*60*1e3;class as{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new ls(n),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){var e,n;const r=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=ze();if(!(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null))&&!(this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(o=>o.date===i)))return this._heartbeatsCache.heartbeats.push({date:i,agent:r}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(o=>{const c=new Date(o.date).valueOf();return Date.now()-c<=os}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){var e;if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=ze(),{heartbeatsToSend:s,unsentEntries:r}=cs(this._heartbeatsCache.heartbeats),i=re(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=n,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function ze(){return new Date().toISOString().substring(0,10)}function cs(t,e=is){const n=[];let s=t.slice();for(const r of t){const i=n.find(o=>o.agent===r.agent);if(i){if(i.dates.push(r.date),je(n)>e){i.dates.pop();break}}else if(n.push({agent:r.agent,dates:[r.date]}),je(n)>e){n.pop();break}s=s.slice(1)}return{heartbeatsToSend:n,unsentEntries:s}}class ls{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Jt()?Yt().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await rs(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const r=await this.read();return He(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const r=await this.read();return He(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function je(t){return re(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function us(t){oe(new Y("platform-logger",e=>new vn(e),"PRIVATE")),oe(new Y("heartbeat",e=>new as(e),"PRIVATE")),q(ye,Fe,t),q(ye,Fe,"esm2017"),q("fire-js","")}us("");var hs="firebase",ds="10.11.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const at="firebasestorage.googleapis.com",ct="storageBucket",fs=2*60*1e3,ps=10*60*1e3,_s=1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${this.customData.serverResponse}`:this.message=this._baseMessage}}var m;(function(t){t.UNKNOWN="unknown",t.OBJECT_NOT_FOUND="object-not-found",t.BUCKET_NOT_FOUND="bucket-not-found",t.PROJECT_NOT_FOUND="project-not-found",t.QUOTA_EXCEEDED="quota-exceeded",t.UNAUTHENTICATED="unauthenticated",t.UNAUTHORIZED="unauthorized",t.UNAUTHORIZED_APP="unauthorized-app",t.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",t.INVALID_CHECKSUM="invalid-checksum",t.CANCELED="canceled",t.INVALID_EVENT_NAME="invalid-event-name",t.INVALID_URL="invalid-url",t.INVALID_DEFAULT_BUCKET="invalid-default-bucket",t.NO_DEFAULT_BUCKET="no-default-bucket",t.CANNOT_SLICE_BLOB="cannot-slice-blob",t.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",t.NO_DOWNLOAD_URL="no-download-url",t.INVALID_ARGUMENT="invalid-argument",t.INVALID_ARGUMENT_COUNT="invalid-argument-count",t.APP_DELETED="app-deleted",t.INVALID_ROOT_OPERATION="invalid-root-operation",t.INVALID_FORMAT="invalid-format",t.INTERNAL_ERROR="internal-error",t.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(m||(m={}));function pe(t){return"storage/"+t}function Se(){const t="An unknown error occurred, please check the error payload for server response.";return new g(m.UNKNOWN,t)}function ms(t){return new g(m.OBJECT_NOT_FOUND,"Object '"+t+"' does not exist.")}function gs(t){return new g(m.QUOTA_EXCEEDED,"Quota for bucket '"+t+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function bs(){const t="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new g(m.UNAUTHENTICATED,t)}function Es(){return new g(m.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function ys(t){return new g(m.UNAUTHORIZED,"User does not have permission to access '"+t+"'.")}function lt(){return new g(m.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function ut(){return new g(m.CANCELED,"User canceled the upload/download.")}function ws(t){return new g(m.INVALID_URL,"Invalid URL '"+t+"'.")}function vs(t){return new g(m.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+t+"'.")}function Ts(){return new g(m.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+ct+"' property when initializing the app?")}function ht(){return new g(m.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function Is(){return new g(m.SERVER_FILE_WRONG_SIZE,"Server recorded incorrect upload file size, please retry the upload.")}function Rs(t){return new g(m.UNSUPPORTED_ENVIRONMENT,`${t} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function Te(t){return new g(m.INVALID_ARGUMENT,t)}function dt(){return new g(m.APP_DELETED,"The Firebase app was deleted.")}function Ss(t){return new g(m.INVALID_ROOT_OPERATION,"The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function J(t,e){return new g(m.INVALID_FORMAT,"String does not match format '"+t+"': "+e)}function X(t){throw new g(m.INTERNAL_ERROR,"Internal error: "+t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let s;try{s=T.makeFromUrl(e,n)}catch{return new T(e,"")}if(s.path==="")return s;throw vs(e)}static makeFromUrl(e,n){let s=null;const r="([A-Za-z0-9.\\-_]+)";function i(E){E.path.charAt(E.path.length-1)==="/"&&(E.path_=E.path_.slice(0,-1))}const o="(/(.*))?$",c=new RegExp("^gs://"+r+o,"i"),a={bucket:1,path:3};function l(E){E.path_=decodeURIComponent(E.path)}const u="v[A-Za-z0-9_]+",h=n.replace(/[.]/g,"\\."),f="(/([^?#]*).*)?$",d=new RegExp(`^https?://${h}/${u}/b/${r}/o${f}`,"i"),p={bucket:1,path:3},I=n===at?"(?:storage.googleapis.com|storage.cloud.google.com)":n,b="([^?#]*)",D=new RegExp(`^https?://${I}/${r}/${b}`,"i"),y=[{regex:c,indices:a,postModify:i},{regex:d,indices:p,postModify:l},{regex:D,indices:{bucket:1,path:2},postModify:l}];for(let E=0;E<y.length;E++){const z=y[E],j=z.regex.exec(e);if(j){const ce=j[z.indices.bucket];let G=j[z.indices.path];G||(G=""),s=new T(ce,G),z.postModify(s);break}}if(s==null)throw ws(e);return s}}class As{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function De(t,e,n){let s=e;return n==null&&(s=`https://${e}`),`${n}://${s}/v0${t}`}function Bs(t){const e=encodeURIComponent;let n="?";for(const s in t)if(t.hasOwnProperty(s)){const r=e(s)+"="+e(t[s]);n=n+r+"&"}return n=n.slice(0,-1),n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ns{constructor(e,n,s,r,i,o,c,a,l,u,h,f=!0){this.url_=e,this.method_=n,this.headers_=s,this.body_=r,this.successCodes_=i,this.additionalRetryCodes_=o,this.callback_=c,this.errorCallback_=a,this.timeout_=l,this.progressCallback_=u,this.connectionFactory_=h,this.retry=f,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((d,p)=>{this.resolve_=d,this.reject_=p,this.start_()})}start_(){const e=(s,r)=>{if(r){s(!1,new ne(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const o=c=>{const a=c.loaded,l=c.lengthComputable?c.total:-1;this.progressCallback_!==null&&this.progressCallback_(a,l)};this.progressCallback_!==null&&i.addUploadProgressListener(o),i.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(o),this.pendingConnection_=null;const c=i.getErrorCode()===F.NO_ERROR,a=i.getStatus();if(!c||ft(a,this.additionalRetryCodes_)&&this.retry){const u=i.getErrorCode()===F.ABORT;s(!1,new ne(!1,null,u));return}const l=this.successCodes_.indexOf(a)!==-1;s(!0,new ne(l,i))})},n=(s,r)=>{const i=this.resolve_,o=this.reject_,c=r.connection;if(r.wasSuccessCode)try{const a=this.callback_(c,c.getResponse());Os(a)?i(a):i()}catch(a){o(a)}else if(c!==null){const a=Se();a.serverResponse=c.getErrorText(),this.errorCallback_?o(this.errorCallback_(c,a)):o(a)}else if(r.canceled){const a=this.appDelete_?dt():ut();o(a)}else{const a=lt();o(a)}};this.canceled_?n(!1,new ne(!1,null,!0)):this.backoffId_=Cs(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&Ds(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class ne{constructor(e,n,s){this.wasSuccessCode=e,this.connection=n,this.canceled=!!s}}function Ps(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function Ms(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e??"AppManager")}function xs(t,e){e&&(t["X-Firebase-GMPID"]=e)}function Ls(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function Fs(t,e,n,s,r,i,o=!0){const c=Bs(t.urlParams),a=t.url+c,l=Object.assign({},t.headers);return xs(l,e),Ps(l,n),Ms(l,i),Ls(l,s),new Ns(a,t.method,l,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,r,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $s(){return typeof BlobBuilder<"u"?BlobBuilder:typeof WebKitBlobBuilder<"u"?WebKitBlobBuilder:void 0}function Hs(...t){const e=$s();if(e!==void 0){const n=new e;for(let s=0;s<t.length;s++)n.append(t[s]);return n.getBlob()}else{if(Ce())return new Blob(t);throw new g(m.UNSUPPORTED_ENVIRONMENT,"This browser doesn't seem to support creating Blobs")}}function zs(t,e,n){return t.webkitSlice?t.webkitSlice(e,n):t.mozSlice?t.mozSlice(e,n):t.slice?t.slice(e,n):null}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function js(t){if(typeof atob>"u")throw Rs("base-64");return atob(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class _e{constructor(e,n){this.data=e,this.contentType=n||null}}function Vs(t,e){switch(t){case C.RAW:return new _e(pt(e));case C.BASE64:case C.BASE64URL:return new _e(_t(t,e));case C.DATA_URL:return new _e(Ws(e),Gs(e))}throw Se()}function pt(t){const e=[];for(let n=0;n<t.length;n++){let s=t.charCodeAt(n);if(s<=127)e.push(s);else if(s<=2047)e.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(n<t.length-1&&(t.charCodeAt(n+1)&64512)===56320))e.push(239,191,189);else{const i=s,o=t.charCodeAt(++n);s=65536|(i&1023)<<10|o&1023,e.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?e.push(239,191,189):e.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(e)}function qs(t){let e;try{e=decodeURIComponent(t)}catch{throw J(C.DATA_URL,"Malformed data URL.")}return pt(e)}function _t(t,e){switch(t){case C.BASE64:{const r=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(r||i)throw J(t,"Invalid character '"+(r?"-":"_")+"' found: is it base64url encoded?");break}case C.BASE64URL:{const r=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(r||i)throw J(t,"Invalid character '"+(r?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=js(e)}catch(r){throw r.message.includes("polyfill")?r:J(t,"Invalid character found")}const s=new Uint8Array(n.length);for(let r=0;r<n.length;r++)s[r]=n.charCodeAt(r);return s}class mt{constructor(e){this.base64=!1,this.contentType=null;const n=e.match(/^data:([^,]+)?,/);if(n===null)throw J(C.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=n[1]||null;s!=null&&(this.base64=Xs(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=e.substring(e.indexOf(",")+1)}}function Ws(t){const e=new mt(t);return e.base64?_t(C.BASE64,e.rest):qs(e.rest)}function Gs(t){return new mt(t).contentType}function Xs(t,e){return t.length>=e.length?t.substring(t.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k{constructor(e,n){let s=0,r="";Ve(e)?(this.data_=e,s=e.size,r=e.type):e instanceof ArrayBuffer?(n?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),s=this.data_.length):e instanceof Uint8Array&&(n?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),s=e.length),this.size_=s,this.type_=r}size(){return this.size_}type(){return this.type_}slice(e,n){if(Ve(this.data_)){const s=this.data_,r=zs(s,e,n);return r===null?null:new k(r)}else{const s=new Uint8Array(this.data_.buffer,e,n-e);return new k(s,!0)}}static getBlob(...e){if(Ce()){const n=e.map(s=>s instanceof k?s.data_:s);return new k(Hs.apply(null,n))}else{const n=e.map(o=>Ae(o)?Vs(C.RAW,o).data:o.data_);let s=0;n.forEach(o=>{s+=o.byteLength});const r=new Uint8Array(s);let i=0;return n.forEach(o=>{for(let c=0;c<o.length;c++)r[i++]=o[c]}),new k(r,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ks(t){let e;try{e=JSON.parse(t)}catch{return null}return Us(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Js(t){if(t.length===0)return null;const e=t.lastIndexOf("/");return e===-1?"":t.slice(0,e)}function Ys(t,e){const n=e.split("/").filter(s=>s.length>0).join("/");return t.length===0?n:t+"/"+n}function gt(t){const e=t.lastIndexOf("/",t.length-2);return e===-1?t:t.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zs(t,e){return e}class w{constructor(e,n,s,r){this.server=e,this.local=n||e,this.writable=!!s,this.xform=r||Zs}}let se=null;function Qs(t){return!Ae(t)||t.length<2?t:gt(t)}function er(){if(se)return se;const t=[];t.push(new w("bucket")),t.push(new w("generation")),t.push(new w("metageneration")),t.push(new w("name","fullPath",!0));function e(i,o){return Qs(o)}const n=new w("name");n.xform=e,t.push(n);function s(i,o){return o!==void 0?Number(o):o}const r=new w("size");return r.xform=s,t.push(r),t.push(new w("timeCreated")),t.push(new w("updated")),t.push(new w("md5Hash",null,!0)),t.push(new w("cacheControl",null,!0)),t.push(new w("contentDisposition",null,!0)),t.push(new w("contentEncoding",null,!0)),t.push(new w("contentLanguage",null,!0)),t.push(new w("contentType",null,!0)),t.push(new w("metadata","customMetadata",!0)),se=t,se}function tr(t,e){function n(){const s=t.bucket,r=t.fullPath,i=new T(s,r);return e._makeStorageReference(i)}Object.defineProperty(t,"ref",{get:n})}function nr(t,e,n){const s={};s.type="file";const r=n.length;for(let i=0;i<r;i++){const o=n[i];s[o.local]=o.xform(s,e[o.server])}return tr(s,t),s}function sr(t,e,n){const s=Ks(e);return s===null?null:nr(t,s,n)}function bt(t,e){const n={},s=e.length;for(let r=0;r<s;r++){const i=e[r];i.writable&&(n[i.server]=t[i.local])}return JSON.stringify(n)}class Q{constructor(e,n,s,r){this.url=e,this.method=n,this.handler=s,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function N(t){if(!t)throw Se()}function Oe(t,e){function n(s,r){const i=sr(t,r,e);return N(i!==null),i}return n}function ee(t){function e(n,s){let r;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?r=Es():r=bs():n.getStatus()===402?r=gs(t.bucket):n.getStatus()===403?r=ys(t.path):r=s,r.status=n.getStatus(),r.serverResponse=s.serverResponse,r}return e}function rr(t){const e=ee(t);function n(s,r){let i=e(s,r);return s.getStatus()===404&&(i=ms(t.path)),i.serverResponse=r.serverResponse,i}return n}function ir(t,e,n){const s=e.fullServerUrl(),r=De(s,t.host,t._protocol),i="GET",o=t.maxOperationRetryTime,c=new Q(r,i,Oe(t,n),o);return c.errorHandler=rr(e),c}function or(t,e){return t&&t.contentType||e&&e.type()||"application/octet-stream"}function Et(t,e,n){const s=Object.assign({},n);return s.fullPath=t.path,s.size=e.size(),s.contentType||(s.contentType=or(null,e)),s}function ar(t,e,n,s,r){const i=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function c(){let y="";for(let E=0;E<2;E++)y=y+Math.random().toString().slice(2);return y}const a=c();o["Content-Type"]="multipart/related; boundary="+a;const l=Et(e,s,r),u=bt(l,n),h="--"+a+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hr{constructor(e,n,s){if(ks(e)||n!=null||s!=null)this.next=e,this.error=n??void 0,this.complete=s??void 0;else{const i=e;this.next=i.next,this.error=i.error,this.complete=i.complete}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pr{constructor(e,n,s=null){this._transferred=0,this._needToFetchStatus=!1,this._needToFetchMetadata=!1,this._observers=[],this._error=void 0,this._uploadUrl=void 0,this._request=void 0,this._chunkMultiplier=1,this._resolve=void 0,this._reject=void 0,this._ref=e,this._blob=n,this._metadata=s,this._mappings=er(),this._resumable=this._shouldDoResumable(this._blob),this._state="running",this._errorHandler=r=>{if(this._request=void 0,this._chunkMultiplier=1,r._codeEquals(m.CANCELED))this._needToFetchStatus=!0,this.completeTransitions_();else{const i=this.isExponentialBackoffExpired();if(ft(r.status,[]))if(i)r=lt();else{this.sleepTime=Math.max(this.sleepTime*2,_s),this._needToFetchStatus=!0,this.completeTransitions_();return}this._error=r,this._transition("error")}},this._metadataErrorHandler=r=>{this._request=void 0,r._codeEquals(m.CANCELED)?this.completeTransitions_():(this._error=r,this._transition("error"))},this.sleepTime=0,this.maxSleepTime=this._ref.storage.maxUploadRetryTime,this._promise=new Promise((r,i)=>{this._resolve=r,this._reject=i,this._start()}),this._promise.then(null,()=>{})}isExponentialBackoffExpired(){return this.sleepTime>this.maxSleepTime}_makeProgressCallback(){const e=this._transferred;return n=>this._updateProgress(e+n)}_shouldDoResumable(e){return e.size()>256*1024}_start(){this._state==="running"&&this._request===void 0&&(this._resumable?this._uploadUrl===void 0?this._createResumable():this._needToFetchStatus?this._fetchStatus():this._needToFetchMetadata?this._fetchMetadata():this.pendingTimeout=setTimeout(()=>{this.pendingTimeout=void 0,this._continueUpload()},this.sleepTime):this._oneShotUpload())}_resolveToken(e){Promise.all([this._ref.storage._getAuthToken(),this._ref.storage._getAppCheckToken()]).then(([n,s])=>{switch(this._state){case"running":e(n,s);break;case"canceling":this._transition("canceled");break;case"pausing":this._transition("paused");break}})}_createResumable(){this._resolveToken((e,n)=>{const s=cr(this._ref.storage,this._ref._location,this._mappings,this._blob,this._metadata),r=this._ref.storage._makeRequest(s,K,e,n);this._request=r,r.getPromise().then(i=>{this._request=void 0,this._uploadUrl=i,this._needToFetchStatus=!1,this.completeTransitions_()},this._errorHandler)})}_fetchStatus(){const e=this._uploadUrl;this._resolveToken((n,s)=>{const r=lr(this._ref.storage,this._ref._location,e,this._blob),i=this._ref.storage._makeRequest(r,K,n,s);this._request=i,i.getPromise().then(o=>{o=o,this._request=void 0,this._updateProgress(o.current),this._needToFetchStatus=!1,o.finalized&&(this._needToFetchMetadata=!0),this.completeTransitions_()},this._errorHandler)})}_continueUpload(){const e=We*this._chunkMultiplier,n=new ae(this._transferred,this._blob.size()),s=this._uploadUrl;this._resolveToken((r,i)=>{let o;try{o=ur(this._ref._location,this._ref.storage,s,this._blob,e,this._mappings,n,this._makeProgressCallback())}catch(a){this._error=a,this._transition("error");return}const c=this._ref.storage._makeRequest(o,K,r,i,!1);this._request=c,c.getPromise().then(a=>{this._increaseMultiplier(),this._request=void 0,this._updateProgress(a.current),a.finalized?(this._metadata=a.metadata,this._transition("success")):this.completeTransitions_()},this._errorHandler)})}_increaseMultiplier(){We*this._chunkMultiplier*2<32*1024*1024&&(this._chunkMultiplier*=2)}_fetchMetadata(){this._resolveToken((e,n)=>{const s=ir(this._ref.storage,this._ref._location,this._mappings),r=this._ref.storage._makeRequest(s,K,e,n);this._request=r,r.getPromise().then(i=>{this._request=void 0,this._metadata=i,this._transition("success")},this._metadataErrorHandler)})}_oneShotUpload(){this._resolveToken((e,n)=>{const s=ar(this._ref.storage,this._ref._location,this._mappings,this._blob,this._metadata),r=this._ref.storage._makeRequest(s,K,e,n);this._request=r,r.getPromise().then(i=>{this._request=void 0,this._metadata=i,this._updateProgress(this._blob.size()),this._transition("success")},this._errorHandler)})}_updateProgress(e){const n=this._transferred;this._transferred=e,this._transferred!==n&&this._notifyObservers()}_transition(e){if(this._state!==e)switch(e){case"canceling":case"pausing":this._state=e,this._request!==void 0?this._request.cancel():this.pendingTimeout&&(clearTimeout(this.pendingTimeout),this.pendingTimeout=void 0,this.completeTransitions_());break;case"running":const n=this._state==="paused";this._state=e,n&&(this._notifyObservers(),this._start());break;case"paused":this._state=e,this._notifyObservers();break;case"canceled":this._error=ut(),this._state=e,this._notifyObservers();break;case"error":this._state=e,this._notifyObservers();break;case"success":this._state=e,this._notifyObservers();break}}completeTransitions_(){switch(this._state){case"pausing":this._transition("paused");break;case"canceling":this._transition("canceled");break;case"running":this._start();break}}get snapshot(){const e=me(this._state);return{bytesTransferred:this._transferred,totalBytes:this._blob.size(),state:e,metadata:this._metadata,task:this,ref:this._ref}}on(e,n,s,r){const i=new hr(n||void 0,s||void 0,r||void 0);return this._addObserver(i),()=>{this._removeObserver(i)}}then(e,n){return this._promise.then(e,n)}catch(e){return this.then(null,e)}_addObserver(e){this._observers.push(e),this._notifyObserver(e)}_removeObserver(e){const n=this._observers.indexOf(e);n!==-1&&this._observers.splice(n,1)}_notifyObservers(){this._finishPromise(),this._observers.slice().forEach(n=>{this._notifyObserver(n)})}_finishPromise(){if(this._resolve!==void 0){let e=!0;switch(me(this._state)){case v.SUCCESS:V(this._resolve.bind(null,this.snapshot))();break;case v.CANCELED:case v.ERROR:const n=this._reject;V(n.bind(null,this._error))();break;default:e=!1;break}e&&(this._resolve=void 0,this._reject=void 0)}}_notifyObserver(e){switch(me(this._state)){case v.RUNNING:case v.PAUSED:e.next&&V(e.next.bind(e,this.snapshot))();break;case v.SUCCESS:e.complete&&V(e.complete.bind(e))();break;case v.CANCELED:case v.ERROR:e.error&&V(e.error.bind(e,this._error))();break;default:e.error&&V(e.error.bind(e,this._error))()}}resume(){const e=this._state==="paused"||this._state==="pausing";return e&&this._transition("running"),e}pause(){const e=this._state==="running";return e&&this._transition("pausing"),e}cancel(){const e=this._state==="running"||this._state==="pausing";return e&&this._transition("canceling"),e}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H{constructor(e,n){this._service=e,n instanceof T?this._location=n:this._location=T.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new H(e,n)}get root(){const e=new T(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return gt(this._location.path)}get storage(){return this._service}get parent(){const e=Js(this._location.path);if(e===null)return null;const n=new T(this._location.bucket,e);return new H(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw Ss(e)}}function _r(t,e,n){return t._throwIfRoot("uploadBytesResumable"),new pr(t,new k(e),n)}function mr(t,e){const n=Ys(t._location.path,e),s=new T(t._location.bucket,n);return new H(t.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wt="storage";function wr(t,e,n){return t=Ie(t),_r(t,e,n)}function vr(t,e){return t=Ie(t),Er(t,e)}function Tr(t=ts(),e){t=Ie(t);const s=Yn(t,wt).getImmediate({identifier:e}),r=Gt("storage");return r&&Ir(s,...r),s}function Ir(t,e,n,s={}){yr(t,e,n,s)}function Rr(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new Ue(n,s,r,e,es)}function Sr(){oe(new Y(wt,Rr,"PUBLIC").setMultipleInstances(!0)),q(Xe,Ke,""),q(Xe,Ke,"esm2017")}Sr();function Je(t){const e=t;e.__i18n=e.__i18n||[],e.__i18n.push({locale:"",resource:{fr:{meta:{title:{t:0,b:{t:2,i:[{t:3}],s:"Partage de photos et vidéos - Mariage Agnès et Florent"}},description:{t:0,b:{t:2,i:[{t:3}],s:"Vous pouvez nous partager vos photos et vidéos ici."}}},title:{t:0,b:{t:2,i:[{t:3}],s:"Partage de photos et vidéos"}},takePictureButton:{t:0,b:{t:2,i:[{t:3}],s:"Prendre une photo"}},shareAssetButton:{t:0,b:{t:2,i:[{t:3}],s:"Partager photos & vidéos"}},uploading:{t:0,b:{t:2,i:[{t:3}],s:"En cours"}},uploadingPaused:{t:0,b:{t:2,i:[{t:3}],s:"En pause"}},uploadingError:{t:0,b:{t:2,i:[{t:3}],s:"Une erreur est survenu."}},uploadingSuccess:{t:0,b:{t:2,i:[{t:3}],s:"Chargé ! 🎉"}}},en:{meta:{title:{t:0,b:{t:2,i:[{t:3}],s:"Sharing photos and videos - Agnès and Florent wedding"}},description:{t:0,b:{t:2,i:[{t:3}],s:"You can share your photos and videos here."}}},title:{t:0,b:{t:2,i:[{t:3}],s:"Sharing photos and videos"}},takePictureButton:{t:0,b:{t:2,i:[{t:3}],s:"Take a picture"}},shareAssetButton:{t:0,b:{t:2,i:[{t:3}],s:"Share photos & videos"}},uploading:{t:0,b:{t:2,i:[{t:3}],s:"Uploading"}},uploadingPaused:{t:0,b:{t:2,i:[{t:3}],s:"Paused"}},uploadingError:{t:0,b:{t:2,i:[{t:3}],s:"An error occurred."}},uploadingSuccess:{t:0,b:{t:2,i:[{t:3}],s:"Uploaded! 🎉"}}}}})}const vt=t=>(Ut("data-v-11117126"),t=t(),Bt(),t),Ar={id:"wedding-design-system"},Cr={class:"title typography-title-2"},Dr={key:0,class:"background-img",src:Pt,alt:""},Or={key:1,class:"preview-container"},kr=["src"],Ur={key:0,class:"preview-progression-container"},Br={class:"typography-paragraph"},Nr=["value"],Pr={key:1,class:"preview-progression-container"},Mr={key:2,class:"preview-progression-container"},xr={class:"action"},Lr=vt(()=>A("img",{alt:"",src:Mt},null,-1)),Fr={key:1,for:"imageInput",class:"button"},$r=vt(()=>A("img",{alt:"",src:xt},null,-1)),Tt={__name:"photo",setup(t){const e=kt(),{t:n}=Rt({useScope:"local"});Nt({ogType:"website",title:n("meta.title"),ogTitle:n("meta.title"),twitterTitle:n("meta.title"),description:n("meta.description"),ogDescription:n("meta.description"),twitterDescription:n("meta.description"),twitterCard:"summary",ogUrl:"https://berthelot.io/mariage/photo"});const s=te([]),r=te(null),i=te(null),o=te(!1),c=l=>{s.value=[...s.value,...Array.from(l.target.files).map(u=>{const h=`/photos/${u.lastModified}-${u.name}`;return s.value.find(f=>f.firestoreUrl===h)?null:{firestoreUrl:h,objectUrl:URL.createObjectURL(u),rawFile:u,status:"starting",uploadPct:0}}).filter(Boolean)],s.value.filter(u=>u.status==="starting").forEach(u=>{a(u)})},a=l=>{var f;const u=vr(i.value,l.firestoreUrl),h=wr(u,l.rawFile,{customMetadata:{userAgent:window.navigator.userAgent,lastModified:l.rawFile.lastModified,lastModifiedDate:(f=l.rawFile.lastModifiedDate)==null?void 0:f.toISOString(),originalName:l.rawFile.name}});s.value=s.value.map(d=>l.firestoreUrl===d.firestoreUrl?{...d,status:"running"}:d),h.on("state_changed",d=>{s.value=s.value.map(p=>l.firestoreUrl===p.firestoreUrl?{...p,status:d.state,uploadPct:d.bytesTransferred/d.totalBytes*100}:p)},d=>{s.value=s.value.map(p=>l.firestoreUrl===p.firestoreUrl?{...p,status:"error",error:d}:p)},()=>{s.value=s.value.map(d=>l.firestoreUrl===d.firestoreUrl?{...d,status:"success"}:d)})};return St(()=>{const l={apiKey:e.public.FIREBASE_API_KEY,authDomain:e.public.FIREBASE_AUTH_DOMAIN,projectId:e.public.FIREBASE_PROJECT_ID,storageBucket:e.public.FIREBASE_STORAGE_BUCKET,messagingSenderId:e.public.FIREBASE_MESSAGING_SENDER_ID,appId:e.public.FIREBASE_APP_ID};r.value=rt(l),i.value=Tr(r.value);const u=document.createElement("input");o.value=u.capture!==void 0}),(l,u)=>(S(),R("main",Ar,[A("h1",Cr,P(M(n)("title")),1),A("form",{onSubmit:u[0]||(u[0]=Ot((...h)=>l.handleUploadingPhoto&&l.handleUploadingPhoto(...h),["prevent"]))},[s.value.length?x("",!0):(S(),R("img",Dr)),s.value.length?(S(),R("section",Or,[(S(!0),R(At,null,Ct(s.value,h=>(S(),R("article",{key:h.firestoreUrl,class:"preview-item"},[A("img",{class:"preview-img",src:h.objectUrl,alt:""},null,8,kr),["starting","running","paused"].includes(h.status)?(S(),R("div",Ur,[A("span",Br,P(h.status==="paused"?M(n)("uploadingPaused"):M(n)("uploading")),1),A("progress",{class:"preview-progression",max:"100",value:h.uploadPct},null,8,Nr)])):x("",!0),h.status==="error"?(S(),R("div",Pr,P(M(n)("uploadingError"))+P(h.error.message),1)):x("",!0),h.status==="success"?(S(),R("div",Mr,P(M(n)("uploadingSuccess")),1)):x("",!0)]))),128))])):x("",!0),A("div",xr,[A("input",{id:"imageUpload",type:"file",accept:"video/*,image/*",multiple:"",onChange:c},null,32),A("label",{for:"imageUpload",class:Dt({noAnimate:o.value,button:!0})},[Lr,Be(P(M(n)("shareAssetButton")),1)],2),o.value?(S(),R("input",{key:0,id:"imageInput",type:"file",accept:"image/*",capture:"user",onChange:c},null,32)):x("",!0),o.value?(S(),R("label",Fr,[$r,Be(P(M(n)("takePictureButton")),1)])):x("",!0)])],32)]))}};typeof Je=="function"&&Je(Tt);const qr=It(Tt,[["__scopeId","data-v-11117126"]]);export{qr as default};
