import{_ as It,u as Rt,r as te,i as St,c as R,a as A,t as P,f as M,m as x,F as At,g as Ct,s as Dt,d as Be,E as Ot,H as kt,o as S,p as Ut,e as Bt}from"./DOMkUEcl.js";import{u as Nt}from"./Baejb6oA.js";import{b as Pt,a as Mt,_ as xt}from"./4a5k4riB.js";import"./BoQTt7WU.js";var Ne={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Tn(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Tn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ye="@firebase/app",Fe="0.10.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hs(t){oe(new Y("platform-logger",e=>new vn(e),"PRIVATE")),oe(new Y("heartbeat",e=>new cs(e),"PRIVATE")),q(ye,Fe,t),q(ye,Fe,"esm2017"),q("fire-js","")}hs("");var ds="firebase",fs="10.12.2";/**
 * @license
